========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet composant2
========================================================================

AppWizard a créé cette application composant2 pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application composant2
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé composant2.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
